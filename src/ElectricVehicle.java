...
public class ElectricVehicle {
  ...
  private void setSocConstraints(double stateOfCharge) {
  ...
  public ElectricVehicle(String names, double batterySize,
    ...
    setSocConstraints(stateOfCharge);
  }
  ...
  public void updateEfficiency(double currentTemp) {
    if (currentTemp > 77.0) {
      ...
      this.currentEfficiency = (1 - ((65.0 - currentTemp) * 0.01)) * this.defaultEfficiency;
  ...
  public String toString() {
    ...
    return String.format("%s SOC: %s%% Range (miles): %.1f", getName(),
